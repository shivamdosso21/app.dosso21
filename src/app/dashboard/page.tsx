...
const Page: React.FC = () => {
  ...
  return (
    <div className="flex h-screen w-screen bg-gray-200">
      <div
        className={`fixed inset-0 bg-black bg-transparent z-10 md:hidden ${
      ...
      <div className="flex flex-grow flex-col">
        ...
        <main className="flex flex-col items-center gap-4 p-4">
          <div className="h-40 w-full max-w-md rounded-md  bg-white shadow-xl md:w-1/4"></div>
          <div className="w-full flex flex-col items-center gap-4 md:flex-col md:gap-4">
            <div className="flex w-full max-w-md flex-col md:w-1/4">
              <div className="flex justify-between mb-4">
                ...
                <button className="bg-gray-300 p-2 select-none">
                  My Contest
                </button>
              </div>
              <div className="grid w-full gap-2 rounded-xl  bg-white p-4 shadow-xl">
        ...
        <footer className="mt-auto flex h-20 items-center justify-evenly bg-black text-white">
          <button className={`flex flex-col items-center ${pathname === "/" ? "border-b-2 border-yellow-400" : ""}`}>
            <h2 className="text-2xl text-yellow-400">
              <IoHomeOutline />
            </h2>
            <span className="text-yellow-400 select-none">Home</span>
          </button>
          <button className={`flex flex-col items-center ${pathname === "/my_contests" ? "border-b-2 border-yellow-400" : ""}`}>
            <h2 className="text-2xl text-yellow-400 select-none">
              <FaRegPlayCircle />
            </h2>
            <span className="text-yellow-400 select-none">My Contests</span>
          </button>
          <button className={`flex flex-col items-center ${pathname === "/refer_earn" ? "border-b-2 border-yellow-400" : ""}`}>
            <h2 className="text-2xl text-yellow-400">
              <HiOutlineUsers />
            </h2>
